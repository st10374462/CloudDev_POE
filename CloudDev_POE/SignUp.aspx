<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="CloudDev_POE.WebForm1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Welcome to KBCraft: Sign Up Below</h2>
    ...
    <asp:TextBox runat="server" Text="" ID="edtConfirmPassword" />
    <br />
    <br />
